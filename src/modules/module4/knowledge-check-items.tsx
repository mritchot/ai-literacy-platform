...
const KC_4_1: KnowledgeCheckItemData = {
  ...
  options: [
    ...
    {
      id: 'd',
      text: '“Components 1 and 4 are reasonable to delegate, but components 2 and 3 require different treatment. The metric decline narrative requires her interpretive judgment about why it happened in her product context. The model can describe what changed in the numbers, but it has no access to the team conversations, launch timing, or product decisions that explain why. The feature recommendations depend on customer interview insights the model has never seen; those themes live in her notes and memory. Delegating these produces plausible output missing the contextual knowledge driving the VP’s decision. She should keep components 2 and 3 human-only or AI-assisted, where she supplies the contextual reasoning and the AI helps with structure and language, and delegate 1 and 4, where the output is verifiable against a known source.”',
      isPreferred: true,
