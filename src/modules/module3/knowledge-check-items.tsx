  ...
  stem: (
    <>
      <p className="m-0 mb-3">
        ...
        discuss.” The total input is approximately 28,000 tokens. The model’s context window is
        32,000 tokens.
      </p>
      <p className="m-0 mb-3">
