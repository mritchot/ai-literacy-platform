...
export const SAMPLE2_META: MemoMeta = {
  to: 'Design Review Attendees (ID, FE, SME, ES)',
  from: 'L&D Program Manager',
  date: 'April 21, 2026',
...
export const VOICE_NOTE =
  'Both samples use an executive/strategic register: first person, active voice, declarative sentences under 35 words, claims leading with business consequence then evidence then action, and no hedging ("aims to," "may indicate"). It signals the decision-making authority a hiring reviewer expects from an L&D Manager communicating to stakeholders.';
