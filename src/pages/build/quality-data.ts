// Quality-assurance data — the ten verification passes, the triple-validation
// data protocol, and the eight-check capability framework. Drives the QA
// dashboard.
//
// Source: Phase 4 Component 7E Quality Assurance Documentation
// (planning corpus, outside the repo),
