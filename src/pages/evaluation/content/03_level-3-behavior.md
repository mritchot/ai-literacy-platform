...
The market reached the same conclusion the hard way. By late May 2026, [Fortune declared "tokenmaxxing" over](https://fortune.com/2026/05/28/tokenmaxxing-is-dead-companies-didnt-get-the-roi-from-ai-they-wanted-to-see/) as a measure of AI return, after Uber's COO [reported burning the company's entire annual AI budget in four months](https://fortune.com/2026/05/26/uber-coo-ai-spending-tokens-claude-code/) without a clean line to user value, [Amazon deprecated an internal usage leaderboard](https://www.heise.de/en/news/Too-much-tokenmaxxing-Amazon-stops-internal-AI-ranking-11311902.html) (a senior vice president telling staff to "please don't use AI just for the sake of using AI"), and Meta quietly removed its own. These reversals confirm a design principle that predated them: an organization that incentivizes volume rewards the highest-risk behavior, uncritical high-volume delegation with no verification layer.
...
- **heise online** — [*Amazon stops internal AI ranking*](https://www.heise.de/en/news/Too-much-tokenmaxxing-Amazon-stops-internal-AI-ranking-11311902.html) (May 2026) (the deprecated leaderboard and the "don't use AI just for the sake of using AI" guidance; first reported by the Financial Times, confirmed by Business Insider)
